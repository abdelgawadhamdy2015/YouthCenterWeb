...
namespace YouthCenterWeb.YouthCenterWeb.Api.Controllers
{
    ...
    [Authorize]
    public class YouthCenterActivityController(IGenericService<YouthCenterActivity, YouthCenterActivityDto, CreateYouthCenterActivityDto> service) : ControllerBase
    {
        private readonly IGenericService<YouthCenterActivity, YouthCenterActivityDto, CreateYouthCenterActivityDto> youthCenterActivityService = service;

        [HttpGet]
        public async Task<IActionResult> GetAll()
        {
            var result = await youthCenterActivityService.GetAllAsync();
